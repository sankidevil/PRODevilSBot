...
alive_logo = ALIVE_PIC or "https://graph.org/file/254b476ee2ef76e336b25.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/Classics0012)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/Classics0012)\n"
        f"└• **яєρσ**: [Click](https://graph.org/file/bbd3d7419084d0ae28089.mp4)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here I Fuck you: \n\n\nhttps://graph.org/file/bbd3d7419084d0ae28089.mp4\nFuck & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://graph.org/file/c716454b7a212f0aaa400.jpg")
